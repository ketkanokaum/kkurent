...
//        @Part("user_id") user_id: RequestBody,
    ...
    // ใช้สำหรับลบออกจากสินค้าโปรดในหน้า detail
    @DELETE("deleteFavorite/{productId}/{userId}")
    fun deleteFavorite(
    ...
    fun getFavorite(@Path("idUsers") idUsers: Int): Call<List<Item>>
    ...
    @GET("/checkFavorite/{idItems}/{idUsers}")
    fun checkFavorite(
        @Path("idItems") idItems: Int,
