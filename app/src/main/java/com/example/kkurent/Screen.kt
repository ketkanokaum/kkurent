...
sealed class Screen (val route: String, val name: String,val icon: ImageVector? = null){
    ...
    data object Chat : Screen(route = "chat_screen", name = "แชท", icon = Icons.AutoMirrored.Filled.Chat)
    data object ChatDetail : Screen(route = "chat_detail_screen", name = "แชท", icon = Icons.AutoMirrored.Filled.Chat)
    data object Policy: Screen(route = "policy_screen", name = "Policy")
}